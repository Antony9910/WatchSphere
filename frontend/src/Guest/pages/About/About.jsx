...
const About = () => {
  return (
    <div>
        ...
        <Box sx={{marginTop:5,fontSize:40,fontFamily:'fantasy',marginLeft:80,":hover":{transform:"scale(1.05)",boxShadow:30}}}>ABOUT<InfoIcon></InfoIcon></Box>
        <Box sx={{fontSize:20,marginBottom:2,fontFamily:'inherit'}}><p>
