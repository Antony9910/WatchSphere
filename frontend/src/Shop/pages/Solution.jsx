  ...
  return (
    <Container maxWidth="lg">
      <Box sx={{ padding: "2rem" }}>
        ...
        >
          SOLUTIONS TO CUSTOMER COMPLAINTS<AddCommentIcon></AddCommentIcon>
        </Typography>
      ...
      <Typography sx={{fontFamily:'fantasy',fontSize:20}}>SECOND-HAND WATCH<WatchIcon></WatchIcon></Typography>
              ...
              <Grid item xs={12} sm={6} md={4} key={complaint._id}>
                ...
                >
                  ...
                  <CardActions sx={{ justifyContent: "flex-end" }}>
                    ...
                    <AddIcon></AddIcon><Link to={`/shop/WatchSolution/${complaint._id}`} style={{textDecoration:'none',color:'white',fontFamily:'fantasy'}}>Respond</Link>
                    </Button>
                  </CardActions>
                </Card>
              </Grid>
   ...
   <Typography sx={{fontFamily:'fantasy',fontSize:20}}>SPARE-PARTS<WatchIcon></WatchIcon></Typography>
        <Grid container spacing={3}mt={1}>
            ...
            SparesComplaint.map((SpareComplaint) => (
              <Grid item xs={12} sm={6} md={4} key={SpareComplaint._id}>
                ...
                >
                  ...
                  <CardActions sx={{ justifyContent: "flex-end" }}>
                    <Button variant="contained" color="primary" size="small">
                     <AddIcon></AddIcon> <Link to={`/shop/ProductSolution/${SpareComplaint._id}`} style={{textDecoration:'none',color:'white',fontFamily:'fantasy'}}>Respond</Link>
                    </Button>
                  </CardActions>
                </Card>
              </Grid>
