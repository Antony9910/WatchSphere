...
const EditImage = () => {
  ...
  const fetchSeller = () => {
    ...
    axios.get(`http://localhost:5000/SellerProfileById/${id}`).then((res) => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post(`http://localhost:5000/SellerUploadById/${id}`, formDataToSend)
      .then((res) => {
        
        const newProfileImage = res.data.data.profileImage;

      
        return axios.put(`http://localhost:5000/SellerProfileById/${id}`, { profileImage: newProfileImage });
      })
      .then((res) => {
          ...
          <Grid container spacing={3}>
            ...
            <Grid item xs={12} sm={6}>
              ...
              <CardActions>
                ...
                <Button variant="contained" sx={{ fontFamily: 'fantasy' }} type="submit">
                <Link to={'/seller/profile'} style={{textDecoration:'none',color:'white'}}>Profile</Link></Button>
