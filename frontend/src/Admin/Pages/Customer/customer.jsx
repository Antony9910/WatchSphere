          ...
          <TableBody>
            {userRows.map((user, index) => (
              <TableRow key={index}>
                ...
                <TableCell align="center" sx={{fontFamily:'fantasy'}}>{user.name}</TableCell>
                <TableCell align="center"sx={{fontFamily:'fantasy'}}>{user.email}</TableCell>
                <TableCell align="center"sx={{fontFamily:'fantasy'}}>{user.address}</TableCell>
                <TableCell align="center"sx={{fontFamily:'fantasy'}}>{user.contact}</TableCell>
                <TableCell align="center"sx={{fontFamily:'fantasy'}}>{user.state}</TableCell>
              </TableRow>
            ))}
          </TableBody>
        </Table>
